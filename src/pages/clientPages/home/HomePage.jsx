  ...
  return (
    <>
      ...
      <div className="w-[100%] h-[100vh] bg-purple-200 flex justify-center">
        {/* hero section */}
        <div className="w-[100%] h-[650px] bg-purple-800 overflow-hidden">
          {/* hero image */}
          <div
          ...
          >
            ...
            <div className="h-full w-full bg-black bg-opacity-30">
              ...
              <div className="h-full w-full flex flex-col items-center mt-[30px]">
                ...
                {/* booking placeholder */}
                <div className="w-[80%] h-[430px] p-[12px] flex flex-col justify-center items-center bg-purple-300 bg-opacity-50 rounded-bl-[50px] rounded-tr-[50px] ">
